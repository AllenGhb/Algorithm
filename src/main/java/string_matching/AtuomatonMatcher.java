...
public class AtuomatonMatcher {
    ...
    // 假设字母表有256个字符
    final public static int NO_OF_CHARS = 256;
     ...
     * @author 周何圳 2018年09月11日 新建
     */
    public static int getNextState(char[] pat,int pLength,int y,int x){
     ...
     * @author 周何圳 2018年09月11日 新建
     */
    public static void computeTF(char[] pat,int pLength,int[][] TF){
        int state,x;
